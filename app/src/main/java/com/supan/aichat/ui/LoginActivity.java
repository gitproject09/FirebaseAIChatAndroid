...
import com.lovely_dialog.library.LovelyInfoDialog;
import com.lovely_dialog.library.LovelyProgressDialog;
import com.supan.aichat.R;
import com.supan.aichat.data.SharedPreferenceHelper;
import com.supan.aichat.data.StaticConfig;
import com.supan.aichat.model.User;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Switch switchToPhone = findViewById(R.id.switch1);
                            ...
                            if (!task.isSuccessful()) {
                                new LovelyInfoDialog(LoginActivity.this) {
                                    ...
                                    public LovelyInfoDialog setConfirmButtonText(String text) {
                                        findView(com.lovely_dialog.library.R.id.ld_btn_confirm).setOnClickListener(new View.OnClickListener() {
                                            @Override
                                            public void onClick(View view) {
                                                dismiss();
                                            }
